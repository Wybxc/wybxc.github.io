...
In the winners' circle are slint and egui (_edit on 2026-08-25: and GPUI Component_). Beyond having APIs free of obvious friction or pitfalls, they also provide solid support for IME and accessibility. They respectively occupy the two thrones of retained-mode UI and immediate-mode UI.
